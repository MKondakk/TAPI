...
import { createAppointment, deleteAppointment, getAllAppointments, getAppointmentById, getAppointmentsByDoctorId, getAppointmentsByPatientId, updateAppointment } from '../services/appointmentService';
...
import { APPOINTMENT_RESPONSE, GET_ALL_APPOINTMENTS_RESPONSE } from '../examples/appointment';
...
export class AppointmentController extends Controller {
    ...
    public async getAppoinmentById(@Path() id: number, @Request() req: express.Request): Promise<any> {
    ...
    @Response<InternalError>(500, 'Unexpected error')
    @Example<Appointment>(APPOINTMENT_RESPONSE)
    public async createAppointment(@Body() requestBody: CreateAppointmentRequest, @Request() req: express.Request): Promise<any> {
    ...
    public async deleteAppointment(@Path() id: number, @Request() req: express.Request): Promise<any> {
