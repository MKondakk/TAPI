import { Controller, Get, Post, Route, Body, Request, Path, Response, Tags, SuccessResponse, Delete, Put, Example } from 'tsoa';
...
import { createOwner, deleteOwner, getAllOwners, getOwnerById, updateOwner } from '../services/ownerService';
...
export class OwnerController extends Controller {
    ...
    public async getOwnerById(@Path() id: number, @Request() req: express.Request): Promise<any> {
    ...
    @Response<InternalError>(500, 'Unexpected error')
    @Example<Owner>(OWNER_RESPONSE)
    public async createOwner(@Body() requestBody: CreateOwnerRequest, @Request() req: express.Request): Promise<any> {
    ...
    @Response<InternalError>(500, 'Unexpected error')
    @Example<Owner>(OWNER_RESPONSE)
    public async updateOwner(@Path() id: number, @Body() requestBody: CreateOwnerRequest, @Request() req: express.Request): Promise<any> {
    ...
    public async deleteOwner(@Path() id: number, @Request() req: express.Request): Promise<any> {
